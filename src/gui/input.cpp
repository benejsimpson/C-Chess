...
namespace
{
    ...
    MoveFlag promotion_flag_for_index(int index)
    {
        const MoveFlag flags[4] = {Q_PROMO, R_PROMO, B_PROMO, N_PROMO};
        return flags[index];
    }
}
    ...
    TextBox &fen_box)
{
    ...
    {
        for (int i = 0; i < gui.selected_moves.count; ++i)
        {
